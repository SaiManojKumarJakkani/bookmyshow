...
public class Movie {
    ...
    public Movie( String movieName, String genre, String actor, String actress, String producer, String director, String language, String rating) {
    ...
    public void addMovie() throws SQLException {
        ...
        movieDAO.insertNewMovie(this);
    }
    public void getCurrentMovies() throws Exception {
        MovieDAO movieDAO = new MovieDAO();
        movieDAO.getPlayedMovies();
    }
    @Override
